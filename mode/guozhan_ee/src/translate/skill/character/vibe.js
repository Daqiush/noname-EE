export default {
	vibe_zgl_huoji: "火计",
	vibe_zgl_huoji_info: "出牌阶段限一次，你可以将一张红色手牌转化为【火攻】。你使用【火攻】时可以选择修改一项本次【火攻】中的描述：1.弃置->展示；2.花色->颜色；3.其->其与其同一队列的其他角色。",
	vibe_zgl_kanpo: "看破",
	vibe_zgl_kanpo_info: "你可以将一张黑色手牌转化为【无懈可击】。",
	vibe_zgl_bazhen: "八阵",
	vibe_zgl_bazhen_info: "<b>明置技</b>，若不为你的回合，获得前回合角色的一张牌。若你没有防具，视为装备【八卦阵】。",
