export default {
	...
	"#vibe_zhaoyun_yajiao": "锋回刃转，尚有后手。",

	"#gz_vibe_jiangqin:die": "军略未竟，愧对江东。",
	"#vibe_jiangqin_shangyi": "先观其意，再断其势。",
	"#vibe_jiangqin_jianyi": "俭以应变，器亦可锋。",

	"#gz_vibe_bianfuren:die": "家国难全，唯愿诸君安。",
	"#vibe_bianfuren_yide": "同心同德，不可相伤。",
	"#vibe_bianfuren_cijie": "以慈立诫，以诫成礼。",
	"#vibe_bianfuren_yuejian": "俭以养德，物尽其用。",

	"#gz_vibe_zhuhuan:die": "战局虽险，终未负吴。",
	"#vibe_zhuhuan_jutian": "拒其锋芒，反制其势。",
	...
	"#vibe_mengda_liangfan2": "陛下大军金鼓以震，当转都宛、邓；若二敌不平，军无还期。",
